...
class MaterialityEngine:
    ...
    async def register_loss(self, product_id: int, quantity: float, 
    ...
    async def _generate_acta_number(self) -> str:
        ...
        now = datetime.now()
        count = list(await self.core.db.execute_query(
    ...
    async def generate_acta_text(self, acta_number: str) -> str:
        ...
        """
        record = list(await self.core.db.execute_query(
...
"""
    ...
    async def get_pending_losses(self) -> List[Dict]:
        ...
        result = list(await self.core.db.execute_query(
