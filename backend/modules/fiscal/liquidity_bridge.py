...
class CryptoBridge:
    ...
    async def get_available_for_conversion(self) -> Dict[str, Any]:
        ...
        try:
            ...
            total_serie_b = Decimal(row_b['total'] or 0).quantize(Decimal("0.01")) if row_b else Decimal("0")
        except Exception:
            total_serie_b = Decimal("0")
        ...
        try:
            ...
            total_converted = Decimal(row_c['total'] or 0).quantize(Decimal("0.01")) if row_c else Decimal("0")
            ...
            total_expenses = Decimal(row_e['total'] or 0).quantize(Decimal("0.01")) if row_e else Decimal("0")
        except Exception:
