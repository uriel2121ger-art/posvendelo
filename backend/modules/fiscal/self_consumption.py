...
class SelfConsumptionEngine:
    ...
    async def register_consumption(self, product_id: int, quantity: float,
    ...
    async def register_employee_consumption(self, product_id: int, 
                                       quantity: float,
    ...
    async def get_monthly_summary(self, year: int = None, 
        ...
        sql = """
            ...
            GROUP BY category
        """
        result = list(await self.core.db.execute_query(sql, (str(year), f'{month:02d}')))
    ...
    async def generate_monthly_voucher(self, year: int = None, 
                                  month: int = None) -> Dict[str, Any]:
        """
        ...
        """
        items = list(await self.core.db.execute_query(sql, (str(year), f'{month:02d}')))
