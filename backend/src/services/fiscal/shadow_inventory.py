...
class ShadowInventory:
    ...
    def _ensure_schema(self):
        ...
        self.core.db.execute_write("""
            CREATE TABLE IF NOT EXISTS shadow_movements (
                ...
                real_stock_after DECIMAL(15,2),  -- FIX 2026-02-01: PostgreSQL
                fiscal_stock_after DECIMAL(15,2),  -- FIX 2026-02-01: PostgreSQL
                source TEXT,
                notes TEXT,
    ...
    def get_dual_stock(self, product_id: int) -> Dict[str, Any]:
    ...
    def add_shadow_stock(self, product_id: int, quantity: float, 
        ...
        """
        # Actualizar stock real y shadow
        self.core.db.execute_write("""
            UPDATE products 
            SET stock = stock + %s,
        ...
        dual = self.get_dual_stock(product_id)
    ...
    def sell_with_attribution(self, product_id: int, quantity: float, 
        ...
        if serie == 'A':
            # Venta fiscal - reduce del stock fiscal
            self.core.db.execute_write("""
            ...
            if shadow_available >= quantity:
                ...
                # SECURITY: No loguear a disco - solo shadow_movements
                pass
        
        # Registrar movimiento
        new_dual = self.get_dual_stock(product_id)
    ...
    def get_audit_view(self) -> List[Dict]:
        """
    ...
    def get_real_view(self) -> List[Dict]:
        """
    ...
    def reconcile_fiscal(self, product_id: int, fiscal_stock: float) -> Dict:
        """
...
def activate_shadow_inventory(core) -> Dict:
