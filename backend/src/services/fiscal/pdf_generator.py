...
class CFDIPDFGenerator:
    ...
    def _build_items_table(self, cfdi_data, styles):
        ...
        # TODO [MEDIUM]: Parse XML properly para extraer conceptos del CFDI
        # Requiere: usar ElementTree/lxml para parsear nodos cfdi:Conceptos
        # y extraer Cantidad, Descripcion, ValorUnitario, Importe
