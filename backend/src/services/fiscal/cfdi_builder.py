...
class CFDIBuilder:
    ...
    def _build_comprobante(self, sale_data: Dict[str, Any]) -> etree.Element:
        ...
        attrs = {
            ...
            'Fecha': self._format_datetime(sale_data.get('timestamp')),
    ...
    def _build_impuestos_concepto(self, item: Dict[str, Any]) -> etree.Element:
        ...
        iva_amount = (item_subtotal * Decimal('0.16')).quantize(Decimal('0.01'), rounding=ROUND_HALF_UP)
    ...
    def _build_comprobante_egreso(self, credit_data: Dict[str, Any]) -> etree.Element:
        ...
        attrs = {
            ...
            'Folio': str(self.config.get('folio_actual', 1)),
            'Fecha': self._format_datetime(credit_data.get('timestamp')),
            'FormaPago': credit_data.get('forma_pago', '01'),  # Efectivo default for credit notes
