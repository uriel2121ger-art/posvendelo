...
def init_db():
    ...
    # Insert sample data
    # ClaveProdServ: 01010101 (No existe en el catálogo) -> Use generic 84111506 (Servicios de facturación)
    ...
    # RegimenFiscal: 601 (General de Ley Personas Morales), 616 (Sin obligaciones fiscales), 626 (RESICO)
