...
with open('src/renderer/src/Login.tsx', 'r') as f:
    content = f.read()

# Replace the component contents
start_idx = content.find("export default function Login(): ReactElement {")
if start_idx == -1:
    print("Could not find start")
    sys.exit(1)

new_code = """export default function Login(): ReactElement {
            ...
            <form onSubmit={handleLogin} className="w-full space-y-5 relative">
              ...
              <div className="relative z-20">
                ...
                <div className="relative group">
                  ...
                  >
                    <option value="admin" className="bg-zinc-800">Administrador (admin)</option>
                    <option value="cajero1" className="bg-zinc-800">Cajero Turno 1</option>
                    <option value="cajero2" className="bg-zinc-800">Cajero Turno 2</option>
                  </select>
...
with open('src/renderer/src/Login.tsx', 'w') as f:
    f.write(content)
