// APK OTA updater for Android — POS cashier app
// Checks control-plane manifest for android_cajero artifact and triggers in-app install

const MANIFEST_ARTIFACT = 'android_cajero'
...
/**
 * Checks the control-plane manifest for a newer APK.
...
export async function downloadAndInstallApk(
  downloadUrl: string,
  fileName: string = 'posvendelo-cajero-update.apk'
): Promise<void> {
