...
class CFDIEmailService:
    ...
    def send_cfdi(
        ...
        try:
            ...
            # Email body
            body = self._build_email_body(cfdi_data, custom_message)
    ...
    def _build_email_body(self, cfdi_data: Dict[str, Any], custom_message: Optional[str] = None) -> str:
...
def send_cfdi_email(cfdi_id: int, to_email: str, core) -> Dict[str, Any]:
    """
    ...
    email_config = core.get_fiscal_config().get('email_config', {})
    ...
    return service.send_cfdi(to_email, cfdi_data, xml_path, pdf_path)
