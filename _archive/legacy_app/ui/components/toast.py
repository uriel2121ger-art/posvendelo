...
class Toast(QtWidgets.QWidget):
    ...
    def close_animation(self):
        ...
        try:
            # Usar efecto de opacidad que es más portable
            ...
            # Error en animación, cerrar directamente
            self._finish_close()
    ...
    def show_centered(self, parent: Optional[QtWidgets.QWidget] = None):
        ...
        try:
            ...
            self.fade_in_anim.finished.connect(cleanup_effect)
            self.fade_in_anim.start()
        except Exception:
            # Error en animación, mostrar sin animación
            self.show()
